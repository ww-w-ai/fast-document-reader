...
`INVARIANTS.md` (repo root) is this app's manual: 115 numbered entries, each the measurements
...
|---|---|
| image / diagram / formula sizing, attachments, placeholders | 1, 2, 3, 10, 11, 31, 54, 75, 80, 115 |
...
| tests, corpus probes, "is this check actually reached" | 5, 29, 30, 34, 35, 41, 103, 104, 106, 109, 110, 111, 112, 113, 114 |
