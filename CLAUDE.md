...
sections are DECODED and their geometry is solved (`ColumnGeometry`), but the text does not yet flow in
columns — invariant 100 records the feasibility measurement and what is left.
