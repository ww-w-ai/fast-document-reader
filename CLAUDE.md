...
`INVARIANTS.md` (repo root) is this app's manual: 111 numbered entries, each the measurements
...
| tests, corpus probes, "is this check actually reached" | 5, 29, 30, 34, 35, 41, 103, 104, 106, 109, 110, 111 |
