...
`INVARIANTS.md` (repo root) is this app's manual: 166 numbered entries, each the measurements
...
| printing, `--pdf`, `--extract`, anything headless | 40, 59, 66, 70, 102, 116, 120, 125, 126, 127, 132, 151, 164 |
