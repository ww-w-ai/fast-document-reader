...
`INVARIANTS.md` (repo root) is this app's manual: 98 numbered entries, each the measurements
...
| footnotes — the band fixpoint, where a note lands, the settle's round budget | 98 |
