...
`INVARIANTS.md` (repo root) is this app's manual: 110 numbered entries, each the measurements
...
| markdown parsing or a new markdown feature | 12, 41, 101 |
...
| office readers (docx / odt / hwp), dispatch, rhwp, headings | 29, 33, 44, 45, 73, 75, 78, 79, 81, 94, 110 |
| tests, corpus probes, "is this check actually reached" | 5, 29, 30, 34, 35, 41, 103, 104, 106, 109, 110 |
...
| printing, `--pdf`, `--extract`, anything headless | 40, 59, 66, 70, 102 |
