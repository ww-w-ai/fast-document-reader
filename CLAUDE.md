...
`INVARIANTS.md` (repo root) is this app's manual: 164 numbered entries, each the measurements
...
| `Info.plist`, document types, default handler, sandbox, entitlements | 6, 8, 9, 22, 28, 43, 69, 70, 156 |
...
| office readers (docx / odt / hwp), dispatch, rhwp, headings | 29, 33, 44, 45, 73, 75, 78, 79, 81, 94, 110, 112, 115, 133, 153, 154, 155, 161, 163, 164 |
...
| `RenderTheme` tokens, `OfficeTextBuilder`, style resolution | 36, 37, 97, 107, 163 |
| tables — build, widths, borders, merges, attribute cost | 39, 42, 47, 50, 51, 72, 74, 76, 129, 144, 149, 152, 158, 161, 162, 163, 164 |
