...
`INVARIANTS.md` (repo root) is this app's manual: 169 numbered entries, each the measurements
...
| office readers (docx / odt / hwp), dispatch, rhwp, headings | 29, 33, 44, 45, 73, 75, 78, 79, 81, 94, 110, 112, 115, 133, 153, 154, 155, 161, 163, 164, 165, 166, 169 |
...
| tables — build, widths, borders, merges, attribute cost, nested grids, empty cells | 39, 42, 47, 50, 51, 72, 74, 76, 129, 144, 149, 152, 158, 161, 162, 163, 164, 166, 168, 169 |
