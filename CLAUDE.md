...
`INVARIANTS.md` (repo root) is this app's manual: 163 numbered entries, each the measurements
...
| office readers (docx / odt / hwp), dispatch, rhwp, headings | 29, 33, 44, 45, 73, 75, 78, 79, 81, 94, 110, 112, 115, 133, 153, 154, 155, 161, 163 |
...
| tables — build, widths, borders, merges, attribute cost | 39, 42, 47, 50, 51, 72, 74, 76, 129, 144, 149, 152, 158, 161, 162, 163 |
...
| printing, `--pdf`, `--extract`, anything headless | 40, 59, 66, 70, 102, 116, 120, 125, 126, 127, 132, 151 |
