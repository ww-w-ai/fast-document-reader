...
`INVARIANTS.md` (repo root) is this app's manual: 170 numbered entries, each the measurements
...
| office readers (docx / odt / hwp), dispatch, rhwp, headings | 29, 33, 44, 45, 73, 75, 78, 79, 81, 94, 110, 112, 115, 133, 153, 154, 155, 161, 163, 164, 165, 166, 169, 170 |
| tests, corpus probes, "is this check actually reached" | 5, 29, 30, 34, 35, 41, 103, 104, 106, 109, 110, 111, 112, 113, 114, 116, 119, 122, 124, 134, 135, 136, 157 |
...
| printing, `--pdf`, `--extract`, anything headless | 40, 59, 66, 70, 102, 116, 120, 125, 126, 127, 132, 151, 164, 167 |
