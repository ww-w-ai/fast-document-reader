...
`INVARIANTS.md` (repo root) is this app's manual: 158 numbered entries, each the measurements
...
| office readers (docx / odt / hwp), dispatch, rhwp, headings | 29, 33, 44, 45, 73, 75, 78, 79, 81, 94, 110, 112, 115, 133, 153, 154, 155 |
...
| tables — build, widths, borders, merges, attribute cost | 39, 42, 47, 50, 51, 72, 74, 76, 129, 144, 149, 152, 158 |
...
| paged documents — zoom, page band, header/footer, page outline | 46, 57, 58, 60, 62, 77, 78, 118, 121, 147, 153 |
...
| multi-column layout, `ColumnGeometry`, column flow | 100, 108, 143, 144, 145, 150 |
