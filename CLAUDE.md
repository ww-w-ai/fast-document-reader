...
`INVARIANTS.md` (repo root) is this app's manual: 172 numbered entries, each the measurements
...
| markdown parsing or a new markdown feature, the markdown wire | 12, 41, 101, 122, 123, 128, 130, 131, 162 |
...
| office readers (docx / odt / hwp), dispatch, rhwp, headings | 29, 33, 44, 45, 73, 75, 78, 79, 81, 94, 110, 112, 115, 133, 153, 154, 155, 161, 163, 164, 165, 166, 169, 170, 171, 172 |
| tests, corpus probes, "is this check actually reached" | 5, 29, 30, 34, 35, 41, 103, 104, 106, 109, 110, 111, 112, 113, 114, 116, 119, 122, 124, 134, 135, 136, 157, 171, 172 |
| `RenderTheme` tokens, `OfficeTextBuilder`, style resolution | 36, 37, 97, 107, 163, 165 |
| tables — build, widths, borders, merges, attribute cost, nested grids, empty cells | 39, 42, 47, 50, 51, 72, 74, 76, 129, 144, 149, 152, 158, 161, 162, 163, 164, 166, 168, 169, 170 |
...
| paged documents — zoom, page band, header/footer, page outline | 46, 57, 58, 60, 62, 77, 78, 118, 121, 147, 153, 161, 163 |
| footnotes — the band fixpoint, where a note lands, the settle's round budget | 98, 99, 161 |
| printing, `--pdf`, `--extract`, anything headless | 40, 59, 66, 70, 102, 116, 120, 125, 126, 127, 132, 151, 164, 167, 171 |
| a table that crosses a page boundary | 61, 64, 72, 96, 142, 145 |
